<link href="<?=$us_url_root?>usersc/templates/<?=$settings->template?>/assets/css/plugins/DataTables/dataTables.bootstrap4.min.css" rel="stylesheet">
<link href="<?=$us_url_root?>usersc/templates/<?=$settings->template?>/assets/css/plugins/DataTables/responsive.bootstrap4.min.css" rel="stylesheet">
...
<link href="<?=$us_url_root?>usersc/templates/<?=$settings->template?>/assets/css/plugins/editor/editor.selectize.css" rel="stylesheet">
<link href="<?=$us_url_root?>usersc/templates/<?=$settings->template?>/assets/css/plugins/editor/editor.quill.css" rel="stylesheet">

<link href="<?=$us_url_root?>usersc/templates/<?=$settings->template?>/assets/css/plugins/DataTables/datatables.mark.min.css" rel="stylesheet">