<script>
    ...
    function breakdown(id_hemxxmh, start_date, end_date){
        ...
        // it
        if ($.fn.DataTable.isDataTable('#table_it')) {
            $('#table_it').DataTable().destroy();
        }
        ...
        $('#table_it').DataTable({
            dom: 'lrtip' ,
            ajax: {
                url: "../../models/htsprrd_htlxxmh_h/htsprrd_htlxxmh_h_fn_cek_it.php",
                type: 'POST',
                data: function (d) {
                    d.id_hemxxmh = id_hemxxmh;
                    d.start_date = start_date;
        ...
        // it
        if ($.fn.DataTable.isDataTable('#table_absen_it')) {
            $('#table_absen_it').DataTable().destroy();
        }
        
        // Initialize DataTable
        $('#table_absen_it').DataTable({
            dom: 'lrtip' ,
            ajax: {
                url: "../../models/htsprrd_htlxxmh_h/htsprrd_htlxxmh_h_fn_cek_it.php",
                type: 'POST',
