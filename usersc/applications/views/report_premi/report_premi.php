    ...
    <div class="col">
        <div class="ibox collapsed" id="iboxfilter">
            ...
            <div class="ibox-content">
                <form class="form-horizontal" id="frmreport_premi">
		...
		<div class="ibox ">
			<div class="ibox-content">
				<div class="table-responsive">
                    <table id="tblreport_premi" class="table table-striped table-bordered table-hover nowrap" width="100%">
						<thead>
							<tr>
								<th>ID</th>
								<th>NIK</th>
...
<script type="text/javascript">
		...
		var tblreport_premi, show_inactive_status_report_premi = 0;
		var id_hemxxmh = 0;
		...
		$(document).ready(function() {
			...
			tblreport_premi = $('#tblreport_premi').DataTable( {
				...
				ajax: {
					url: "../../models/report_premi/report_premi.php",
					type: 'POST',
					data: function (d){
				...
				buttons: [
					...
					<?php
						$id_table    = 'id_report_premi';
						$table       = 'tblreport_premi';
						$edt         = 'edtreport_premi';
						$show_status = '_report_premi';
			...
			tblreport_premi.searchPanes.container().appendTo( '#searchPanes1' );

			$("#frmreport_premi").submit(function(e) {
				e.preventDefault();
			}).validate({
				rules: {
					
				},
				submitHandler: function(frmreport_premi) {
					start_date 		= moment($('#start_date').val()).format('YYYY-MM-DD');
					end_date 		= moment($('#end_date').val()).format('YYYY-MM-DD');
					...
					tblreport_premi.rows().deselect();
					tblreport_premi.ajax.reload(function ( json ) {
