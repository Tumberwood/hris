			...
			$html .= '
				...
				<table class="pn" style="font-size: 8px;">
					...
					<tr>
						...
						<td colspan="2" class="text-right">' .number_format($record['pot_pph21'],2,',','.'). '</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2" class="text-right">' .number_format($record['pot_lain'],2,',','.'). '</td>
					</tr>
					<tr>
						<td width="5%"></td>
						...
						<td colspan="2" class="text-right" class="text-right">' .number_format($record['tidak_masuk'],2,',','.'). '</td>
					</tr>
					<tr>
						<td width="5%"></td>
						<td width="24%"></td>
						...
						<td colspan="2" class="text-right">' .number_format($record['pot_makan'],2,',','.'). '</td>
					</tr>
					<tr>
						<td width="5%"></td>
						<td width="24%"></td>
