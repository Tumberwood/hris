    ...
    <div class="col">
        <div class="ibox collapsed" id="iboxfilter">
            ...
            <div class="ibox-content">
                <form class="form-horizontal" id="frmpot_jam_r">
		...
		<div class="ibox ">
			<div class="ibox-content">
				<div class="table-responsive">
                    <table id="tblpot_jam_r" class="table table-striped table-bordered table-hover nowrap" width="100%">
						<thead>
							<tr>
								<th>ID</th>
								<th>NIK</th>
						...
						<tfoot>
							<tr>
								...
								<th class="text-right fw-bold" id="c_orang">Jumlah Orang</th>
								<th colspan="7" class="text-right">Grand Total</th>
								<th class="text-right fw-bold" id="grand_total_ip"></th>
							</tr>
						</tfoot>
                    </table>
				</div>
...
<script type="text/javascript">
		...
		var tblpot_jam_r, show_inactive_status_pot_jam_r = 0;
		var id_hemxxmh = 0;
		...
		$(document).ready(function() {
			...
			//start datatables
			tblpot_jam_r = $('#tblpot_jam_r').DataTable( {
				searchPanes:{
					layout: 'columns-3',
				},
				dom: 
				...
				ajax: {
					url: "../../models/pot_jam_r/pot_jam_r.php",
					type: 'POST',
					data: function (d){
				...
				buttons: [
					...
					<?php
						$id_table    = 'id_pot_jam_r';
						$table       = 'tblpot_jam_r';
						$edt         = 'edtpot_jam_r';
						$show_status = '_pot_jam_r';
			...
			tblpot_jam_r.searchPanes.container().appendTo( '#searchPanes1' );

			$("#frmpot_jam_r").submit(function(e) {
				e.preventDefault();
			}).validate({
				rules: {
					
				},
				submitHandler: function(frmpot_jam_r) {
					start_date 		= moment($('#start_date').val()).format('YYYY-MM-DD');
					end_date 		= moment($('#end_date').val()).format('YYYY-MM-DD');
