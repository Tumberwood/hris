...
<?php
	$nama_tabel    = 'kontrak_jatuh_tempo';
	$nama_tabels_d = [];
		...
		<div class="ibox ">
			<div class="ibox-content">
				<div class="table-responsive">
                    <table id="tblkontrak_jatuh_tempo" class="table table-striped table-bordered table-hover nowrap" width="100%">
						<thead>
							<tr>
								<th>ID</th>
								<th>NIK</th>
...
<script type="text/javascript">
		...
		var tblkontrak_jatuh_tempo, show_inactive_status_kontrak_jatuh_tempo = 0;
		var id_hemxxmh = 0;
		...
		$(document).ready(function() {
			...
			//start datatables
			tblkontrak_jatuh_tempo = $('#tblkontrak_jatuh_tempo').DataTable( {
				searchPanes:{
					layout: 'columns-3',
				},
				dom: 
				...
				ajax: {
					url: "../../models/kontrak_jatuh_tempo/kontrak_jatuh_tempo.php",
					type: 'POST',
					data: function (d){
				...
				buttons: [
					...
					<?php
						$id_table    = 'id_kontrak_jatuh_tempo';
						$table       = 'tblkontrak_jatuh_tempo';
						$edt         = 'edtkontrak_jatuh_tempo';
						$show_status = '_kontrak_jatuh_tempo';
			...
			tblkontrak_jatuh_tempo.searchPanes.container().appendTo( '#searchPanes1' );

			$("#frmkontrak_jatuh_tempo").submit(function(e) {
				e.preventDefault();
			}).validate({
				rules: {
					
				},
				submitHandler: function(frmkontrak_jatuh_tempo) {
					start_date 		= moment($('#start_date').val()).format('YYYY-MM-DD');
					end_date 		= moment($('#end_date').val()).format('YYYY-MM-DD');
					...
					tblkontrak_jatuh_tempo.rows().deselect();
					tblkontrak_jatuh_tempo.ajax.reload(function ( json ) {
