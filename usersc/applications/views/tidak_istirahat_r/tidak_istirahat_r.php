    ...
    <div class="col">
        <div class="ibox collapsed" id="iboxfilter">
            ...
            <div class="ibox-content">
                <form class="form-horizontal" id="frmtidak_istirahat_r">
		...
		<div class="ibox ">
			<div class="ibox-content">
				<div class="table-responsive">
                    <table id="tbltidak_istirahat_r" class="table table-striped table-bordered table-hover nowrap" width="100%">
						<thead>
							<tr>
								<th>ID</th>
								<th>NIK</th>
...
<script type="text/javascript">
		...
		var tbltidak_istirahat_r, show_inactive_status_tidak_istirahat_r = 0;
		var id_hemxxmh = 0;
		...
		$(document).ready(function() {
			...
			//start datatables
			tbltidak_istirahat_r = $('#tbltidak_istirahat_r').DataTable( {
				searchPanes:{
					layout: 'columns-3',
				},
				dom: 
				...
				ajax: {
					url: "../../models/tidak_istirahat_r/tidak_istirahat_r.php",
					type: 'POST',
					data: function (d){
				...
				buttons: [
					...
					<?php
						$id_table    = 'id_tidak_istirahat_r';
						$table       = 'tbltidak_istirahat_r';
						$edt         = 'edttidak_istirahat_r';
						$show_status = '_tidak_istirahat_r';
			...
			tbltidak_istirahat_r.searchPanes.container().appendTo( '#searchPanes1' );

			$("#frmtidak_istirahat_r").submit(function(e) {
				e.preventDefault();
			}).validate({
				rules: {
					
				},
				submitHandler: function(frmtidak_istirahat_r) {
					start_date 		= moment($('#start_date').val()).format('YYYY-MM-DD');
					end_date 		= moment($('#end_date').val()).format('YYYY-MM-DD');
					...
					tbltidak_istirahat_r.rows().deselect();
					tbltidak_istirahat_r.ajax.reload(function ( json ) {
