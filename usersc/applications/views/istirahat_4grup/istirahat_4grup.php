    ...
    <div class="col">
        <div class="ibox collapsed" id="iboxfilter">
            ...
            <div class="ibox-content">
                <form class="form-horizontal" id="frmistirahat_4grup">
		...
		<div class="ibox ">
			<div class="ibox-content">
				<div class="table-responsive">
                    <table id="tblistirahat_4grup" class="table table-striped table-bordered table-hover nowrap" width="100%">
						<thead>
							<tr>
								<th>ID</th>
								<th>NIK</th>
...
<script type="text/javascript">
		...
		var tblistirahat_4grup, show_inactive_status_istirahat_4grup = 0;
		var id_hemxxmh = 0;
		...
		$(document).ready(function() {
			...
			//start datatables
			tblistirahat_4grup = $('#tblistirahat_4grup').DataTable( {
				searchPanes:{
					layout: 'columns-3',
				},
				dom: 
				...
				ajax: {
					url: "../../models/istirahat_4grup/istirahat_4grup.php",
					type: 'POST',
					data: function (d){
				...
				buttons: [
					...
					<?php
						$id_table    = 'id_istirahat_4grup';
						$table       = 'tblistirahat_4grup';
						$edt         = 'edtistirahat_4grup';
						$show_status = '_istirahat_4grup';
			...
			tblistirahat_4grup.searchPanes.container().appendTo( '#searchPanes1' );

			$("#frmistirahat_4grup").submit(function(e) {
				e.preventDefault();
			}).validate({
				rules: {
					
				},
				submitHandler: function(frmistirahat_4grup) {
					start_date 		= moment($('#start_date').val()).format('YYYY-MM-DD');
					end_date 		= moment($('#end_date').val()).format('YYYY-MM-DD');
