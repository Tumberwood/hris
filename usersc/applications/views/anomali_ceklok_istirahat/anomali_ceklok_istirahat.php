...
<?php
	$nama_tabel    = 'anomali_ceklok_istirahat';
	$nama_tabels_d = [];
    ...
    <div class="col">
        <div class="ibox collapsed" id="iboxfilter">
            ...
            <div class="ibox-content">
                <form class="form-horizontal" id="frmanomali_ceklok_istirahat">
		...
		<div class="ibox ">
			<div class="ibox-content">
				<div class="table-responsive">
                    <table id="tblanomali_ceklok_istirahat" class="table table-striped table-bordered table-hover nowrap" width="100%">
						<thead>
							<tr>
								<th>ID</th>
								<th>NIK</th>
...
<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			tblanomali_ceklok_istirahat = $('#tblanomali_ceklok_istirahat').DataTable( {
				...
				ajax: {
					url: "../../models/anomali_ceklok_istirahat/anomali_ceklok_istirahat.php",
					type: 'POST',
					data: function (d){
				...
				buttons: [
					...
					<?php
						$id_table    = 'id_anomali_ceklok_istirahat';
						$table       = 'tblanomali_ceklok_istirahat';
						$edt         = 'edtanomali_ceklok_istirahat';
						$show_status = '_anomali_ceklok_istirahat';
			...
			if (id_hem_get > 0) {
				$("#frmanomali_ceklok_istirahat").submit();
			}
