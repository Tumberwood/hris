...
<?php
	$nama_tabel    = 'anomali_ceklok_pos2_makan';
	$nama_tabels_d = [];
    ...
    <div class="col">
        <div class="ibox collapsed" id="iboxfilter">
            ...
            <div class="ibox-content">
                <form class="form-horizontal" id="frmanomali_ceklok_pos2_makan">
		...
		<div class="ibox ">
			<div class="ibox-content">
				<div class="table-responsive">
                    <table id="tblanomali_ceklok_pos2_makan" class="table table-striped table-bordered table-hover nowrap" width="100%">
						<thead>
						<tr>
							...
							<th rowspan="2" class="align-middle">Area Kerja</th>
							<th rowspan="2" class="align-middle">Sub Tipe</th>
							<th rowspan="2" class="align-middle">Status</th>
							<th rowspan="2" class="align-middle">Tanggal</th>
							<th rowspan="2" class="align-middle">Jadwal</th>
							<th colspan="2" class="text-center">Break In</th>
							<th colspan="2" class="text-center">Break Out</th>
							<th colspan="2" class="text-center">Jam Makan</th>
						</tr>
						<tr>
							<!-- Sub-header Break In -->
							<th>Jam</th>
							<th>Mesin</th>
							<!-- Sub-header Break Out -->
							<th>Jam</th>
							<th>Mesin</th>
							<!-- Sub-header Jam Makan -->
							<th>Jam</th>
							<th>Mesin</th>
						</tr>
						</thead>
...
<script type="text/javascript">
		...
		var tblanomali_ceklok_pos2_makan, show_inactive_status_anomali_ceklok_pos2_makan = 0;
		var id_hemxxmh = 0;
		...
		$(document).ready(function() {
			...
			//start datatables
			tblanomali_ceklok_pos2_makan = $('#tblanomali_ceklok_pos2_makan').DataTable( {
				searchPanes:{
					layout: 'columns-3',
				},
				dom: 
				...
				ajax: {
					url: "../../models/anomali_ceklok_pos2_makan/anomali_ceklok_pos2_makan.php",
					type: 'POST',
					data: function (d){
				...
				columns: [
					...
					{ data: "mesin_break_in" },
					{ data: "break_out" },
					{ data: "mesin_break_out" },
					{ data: "jam_makan" },
					{ data: "mesin_jam_makan" },
				],
				rowGroup: {
				...
				buttons: [
					...
					<?php
						$id_table    = 'id_anomali_ceklok_pos2_makan';
						$table       = 'tblanomali_ceklok_pos2_makan';
						$edt         = 'edtanomali_ceklok_pos2_makan';
						$show_status = '_anomali_ceklok_pos2_makan';
			...
			tblanomali_ceklok_pos2_makan.searchPanes.container().appendTo( '#searchPanes1' );

			$("#frmanomali_ceklok_pos2_makan").submit(function(e) {
				e.preventDefault();
			}).validate({
				rules: {
					
				},
				submitHandler: function(frmanomali_ceklok_pos2_makan) {
					start_date 		= moment($('#start_date').val()).format('YYYY-MM-DD');
					end_date 		= moment($('#end_date').val()).format('YYYY-MM-DD');
					...
					tblanomali_ceklok_pos2_makan.rows().deselect();
					tblanomali_ceklok_pos2_makan.ajax.reload(function ( json ) {
			...
			if (id_hem_get > 0) {
				$("#frmanomali_ceklok_pos2_makan").submit();
			}
