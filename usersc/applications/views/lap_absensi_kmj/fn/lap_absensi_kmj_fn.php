            ...
            */
            ...
            success: function (json) {
                ...
                */
                ...
                str1 += '<table ';
                str1 += 'id="tblhtsprrd1" ';
                str1 += 'class="table table-striped table-bordered table-hover nowrap" ';
                ...
                */
                ...
                str1 += '<th ';
                str1 += 'rowspan="2" ';
                str1 += 'style="vertical-align:middle;text-align:center;">';
                ...
                */
                ...
                $.each(
                    ...
                    function (index, tanggal) {
                        ...
                        str1 += '<th ';
                        str1 += 'colspan="2" ';
                        str1 += 'style="text-align:center;vertical-align:middle;">';
                ...
                $.each(
                    ...
                    function (index, rowData) {
                        ...
                        */
                        ...
                        str1 += '<td ';
                        str1 += 'style="font-weight:500;text-align:left;">';
                        ...
                        $.each(
                            ...
                            function (index, tanggal) {
                                ...
                                */
                                ...
                                var isShiftSiang =
                                    (
                                        shiftLower.indexOf('pagi') !== -1 ||
                                        shiftLower.indexOf('siang') !== -1 ||
                                        shiftLower.indexOf('sore') !== -1
                                    );
                                ...
                                */
                                ...
                                var isShiftMalam =
                                    shiftLower.indexOf('malam') !== -1;


                                /*
                                |--------------------------------------------------------------------------
                                | ATURAN PAGI / SIANG / SORE
                                |--------------------------------------------------------------------------
                                */
                                ...
                                */
                                ...
                                str1 += 'style="text-align:center;font-weight:600;">';
