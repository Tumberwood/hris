    ...
    $.ajax({
        ...
        success: function (json) {
            if (json.data && json.data.length > 0) {
                ...
                // 2. Susun HTML Tabel dengan Header 2 Baris
                var str1 = '<table id="tblhtsprrd1" class="table table-striped table-bordered table-hover nowrap" style="width:100%">';
                str1 += '<thead>';
                ...
                // 3. Susun Array Columns DataTables
                var dynamicColumns = [
                    { 
                        data: "Shift", 
                        title: "Shift",
                ...
                // 4. Inisialisasi DataTables (Tanpa SearchPanes & Karakter <P>)
