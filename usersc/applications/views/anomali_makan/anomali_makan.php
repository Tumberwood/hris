    ...
    <div class="col">
        <div class="ibox collapsed" id="iboxfilter">
            ...
            <div class="ibox-content">
                <form class="form-horizontal" id="frmanomali_makan">
		...
		<div class="ibox ">
			<div class="ibox-content">
				<div class="table-responsive">
                    <table id="tblanomali_makan" class="table table-striped table-bordered table-hover nowrap" width="100%">
						<thead>
							<tr>
								<th>ID</th>
								<th>NIK</th>
...
<script type="text/javascript">
		...
		var tblanomali_makan, show_inactive_status_anomali_makan = 0;
		var id_hemxxmh = 0;
		...
		$(document).ready(function() {
			...
			//start datatables
			tblanomali_makan = $('#tblanomali_makan').DataTable( {
				searchPanes:{
					layout: 'columns-3',
				},
				dom: 
				...
				ajax: {
					url: "../../models/anomali_makan/anomali_makan.php",
					type: 'POST',
					data: function (d){
				...
				buttons: [
					...
					<?php
						$id_table    = 'id_anomali_makan';
						$table       = 'tblanomali_makan';
						$edt         = 'edtanomali_makan';
						$show_status = '_anomali_makan';
			...
			tblanomali_makan.searchPanes.container().appendTo( '#searchPanes1' );

			$("#frmanomali_makan").submit(function(e) {
				e.preventDefault();
			}).validate({
				rules: {
					
				},
				submitHandler: function(frmanomali_makan) {
					start_date 		= moment($('#start_date').val()).format('YYYY-MM-DD');
					end_date 		= moment($('#end_date').val()).format('YYYY-MM-DD');
