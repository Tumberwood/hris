			...
			<div class="ibox-content">
				...
				<div id="custom_hem">
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-lg-6">
								<editor-field name="hemjbmh.is_non_karyawan"></editor-field>
							</div>
							<div class="col-lg-6">
...
<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			edthemxxmh = new $.fn.dataTable.Editor( {
				ajax: {
					url: "../../models/hemxxmh/hemxxmh_non_karyawan.php",
					type: 'POST',
					data: function (d){
			...
			edthemxxmh.on( 'preOpen', function( e, mode, action ) {
				...
				edthemxxmh.field('hemjbmh.is_non_karyawan').disable();
