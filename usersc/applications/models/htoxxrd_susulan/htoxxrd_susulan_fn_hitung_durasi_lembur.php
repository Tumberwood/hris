<?php
     ...
     * 2: TI (30 menit)
     */
    $is_istirahat   = $values['htoxxrd_susulan']['is_istirahat'];
    $id_htotpmh     = $values['htoxxrd_susulan']['id_htotpmh'];
    ...
    if($id_htotpmh == 1 || $id_htotpmh == 2 || $id_htotpmh == 4){
        ...
        $jam_awal	= new Carbon($values['htoxxrd_susulan']['jam_awal']);
        $jam_akhir	= new Carbon($values['htoxxrd_susulan']['jam_akhir']);
