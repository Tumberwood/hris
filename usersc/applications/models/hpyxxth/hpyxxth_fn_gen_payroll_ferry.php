                        ...
                        FLOOR(
                            ...
                            if(alpha_min_satu > 0, alpha_min_satu,
                                if( is_pot_upah_rotasi_lv > 0, 
                                    (if( pot_gp = 0, hk_nik_lama * (pengali_rotasi_old / IF(grup_hk = 1, 21, 25)), (IF(pot_upah_lv_lama > 0, if(id_heyxxmd = 1 AND hesxx = 3, pot_upah_lv_lama * IF(grup_hk = 1, 83509, 70148), pot_upah_lv_lama * pengali_rotasi_old / IF(grup_hk = 1, 21, 25)) , 0)) ))
                                    +
                                    (if( pot_gp = 0, hk_nik_lama * (pengali_jam / IF(grup_hk = 1, 21, 25)), (IF(pot_upah_lv_baru > 0, if(id_heyxxmd = 1 AND hesxx = 3, pot_upah_lv_baru * IF(grup_hk = 1, 83509, 70148), pot_upah_lv_baru * pengali_jam / IF(grup_hk = 1, 21, 25)) , 0)) )),
                                    if( pot_gp = 0 , hk_nik_lama * (pengali_jam / IF(grup_hk = 1, 21, 25)), (IF(report_pot_upah > 0, if(id_heyxxmd = 1 AND hesxx = 3, report_pot_upah * IF(grup_hk = 1, 83509, 70148), report_pot_upah * pengali_jam / IF(grup_hk = 1, 21, 25)) , 0)) )
                                ) 
                            ) 
                        ) AS pot_upah,
