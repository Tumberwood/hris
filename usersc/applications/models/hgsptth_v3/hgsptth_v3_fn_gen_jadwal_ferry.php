<?php 
    ...
    try{
        ...
        if (!empty($rs_find_old_gen)) {
            ...
            ->bind(':tanggal_akhir', $tanggal_akhir)
            ->exec('UPDATE htssctd AS b
                    INNER JOIN hgsemtd_v3 AS a ON a.id_hemxxmh = b.id_hemxxmh AND a.id_hgsptth_v3 = :id_hgsptth_v3
                    SET b.is_active = 0
            ...
            ->exec('INSERT INTO hgsemtd_v3
                    ...
                    INNER JOIN hemxxmh c on c.id = b.id_hemxxmh
                        ...
                        if(b.nama = "minggu", b.shift, 
                            if(jam.kode LIKE "malam%", 3, 
                                if(jam.kode LIKE "pagi%", 1, 
                                    if(jam.id IN (19, 56) OR jam.kode LIKE "%SORE 17:00%" , 3, 2)
                                )
                            ) 
                        ) AS shift
                    FROM hgsptth_v3 AS a
            ...
            ->exec(' INSERT INTO htssctd
                    ...
                    SELECT DISTINCT
                        ...
                        CASE
                            ...
                            THEN DATE_SUB(CONCAT(DATE_ADD(c.sabtu, INTERVAL 1 DAY), " ", TIME(d.jam_akhir)), INTERVAL d.menit_toleransi_awal_out MINUTE)
                            ELSE CONCAT(c.sabtu, " ", TIME(DATE_SUB(d.jam_akhir, INTERVAL d.menit_toleransi_awal_out MINUTE)))
