				...
				->exec(' INSERT INTO htssctd
						...
						SELECT
							...
							CASE
								...
								THEN DATE_SUB(CONCAT(DATE_ADD(c.senjum, INTERVAL 1 DAY), " ", TIME(d.jam_akhir)), INTERVAL d.menit_toleransi_awal_out MINUTE)
								ELSE CONCAT(c.senjum, " ", TIME(DATE_SUB(d.jam_akhir, INTERVAL d.menit_toleransi_awal_out MINUTE)))
