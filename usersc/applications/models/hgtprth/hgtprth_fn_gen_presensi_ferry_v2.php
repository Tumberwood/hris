        ...
        ->exec(' INSERT INTO htsprrd (
                ...
                WITH presensi AS (
                    SELECT
                        ...
                        b.id_hesxxmh,
                        IFNULL(kode_shift, "NJ") AS kode_shift,
                        ...
                        ifnull(is_potong_premi_mid, 0) AS is_potong_premi_mid,
                        ...
                        ceklok_luar,
                        IF(b.id_heyxxmd = 4,
                            ifnull(id_tukar_jadwal, 0),
                            0
                        ) AS id_tukar_jadwal,
                        is_pot_ti,
                        durasi_break_menit,
                        ifnull(potongan_ti_jam, 0) potongan_ti_jam,

                        jam_awal_lembur_awal,
                        jam_akhir_lembur_awal,
                        IFNULL(durasi_lembur_awal_jam, 0) AS durasi_lembur_awal_jam,

                        jam_awal_lembur_akhir,
                        jam_akhir_lembur_akhir,
                        IFNULL(durasi_lembur_akhir_jam, 0) AS durasi_lembur_akhir_jam,

                        jam_awal_lembur_libur,
                        jam_akhir_lembur_libur,
                        IFNULL(durasi_lembur_libur_jam, 0) AS durasi_lembur_libur_jam,

                        jam_awal_lembur_istirahat1,
                        jam_akhir_lembur_istirahat1,
                        IFNULL(durasi_lembur_istirahat1_jam, 0) AS durasi_lembur_istirahat1_jam,

                        jam_awal_lembur_istirahat2,
                        jam_akhir_lembur_istirahat2,
                        IFNULL(durasi_lembur_istirahat2_jam, 0) AS durasi_lembur_istirahat2_jam,

                        jam_awal_lembur_istirahat3,
                        jam_akhir_lembur_istirahat3,
                        IFNULL(durasi_lembur_istirahat3_jam, 0) AS durasi_lembur_istirahat3_jam,
                        
                        IFNULL(durasi_lembur_istirahat1_jam, 0) + IFNULL(durasi_lembur_istirahat2_jam, 0) + IFNULL(durasi_lembur_istirahat3_jam, 0) AS durasi_lembur_ti,
                        IFNULL(durasi_lembur_awal_jam, 0) + IFNULL(durasi_lembur_akhir_jam, 0) + IFNULL(durasi_lembur_libur_jam, 0) AS durasi_lembur_non_ti,
                        IFNULL(durasi_lembur_awal_jam, 0) + IFNULL(durasi_lembur_akhir_jam, 0) + IFNULL(durasi_lembur_libur_jam, 0) + IFNULL(durasi_lembur_istirahat1_jam, 0) + IFNULL(durasi_lembur_istirahat2_jam, 0) + IFNULL(durasi_lembur_istirahat3_jam, 0) AS durasi_lembur_total_jam,

                        (FLOOR(IF(b.id_hesxxmh = 3, IFNULL(nominal_lembur_mati, 0), (IFNULL(nominal_gp, 0) + IFNULL(nominal_t_jab, 0)) / 173))) AS nominal_lembur_jam,
                    ...
                    LEFT JOIN (
                        ...
                        FROM htssctd AS jad
                        LEFT JOIN htsxxmh AS sft ON sft.id = jad.id_htsxxmh
                    ...
                    LEFT JOIN (
                        SELECT
                            ...
                            htlxxrh.is_approve
                        FROM htlxxrh
                        LEFT JOIN htpxxmh ON htpxxmh.id = htlxxrh.id_htlxxmh
                    ...
                    LEFT JOIN (
                        ...
                        FROM (
                            ...
                            LEFT JOIN hevxxmh AS b ON b.id = a.id_hevxxmh
                            LEFT JOIN hemjbmh AS c ON c.id_hevxxmh = b.id
                            WHERE
                                a.id_hpcxxmh = 32
                                AND tanggal_efektif < :tanggal
                        ) AS subquery
                    ...
                    WHERE b.is_checkclock = 1 AND a.is_active = 1 AND b.id_heyxxmh = :id_heyxxmh 
