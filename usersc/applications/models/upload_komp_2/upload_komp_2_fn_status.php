			...
			try{
				...
				for($i = 1; $i < count($sheetData); $i++){
					...
					$komponen = [
						...
						['id_hpcxxmh' => 35,   'nominal' => $sheetData[$i][2]],
						['id_hpcxxmh' => 36,   'nominal' => $sheetData[$i][3]],
					];

					// cari Status
					$qs = $db->query('select','hesxxmh')
					...
					foreach($komponen as $k){
						...
						$qs_check = $db->query('select','htpr_hesxxmh')
							->get(['id'])
