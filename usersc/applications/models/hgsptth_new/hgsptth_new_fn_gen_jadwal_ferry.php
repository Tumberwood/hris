<?php 
    ...
    try{
        ...
        ->exec('DELETE FROM hgsemtd_new WHERE id_hgsptth_new = :id_hgsptth_new
        ');
        ...
        if ($tipe == "Copy") {
            if ($dari_tanggal == null) {
                ...
                ->exec('INSERT INTO htssctd
                    ...
                    FROM htsemtd_new AS a
                    LEFT JOIN pola_shift_new AS b ON b.id_htsptth_new = a.id_htsptth_new AND b.grup = a.grup
                    LEFT JOIN htststd_new AS c ON c.id_htsptth_new = a.id_htsptth_new AND c.shift = b.shift
                    ...
                    LEFT JOIN (
                        SELECT
                            ...
                            id_htsptth_new
                        FROM hgsptth_new
                    ) AS e ON e.id_htsptth_new = c.id_htsptth_new
                    WHERE e.id = :id_hgsptth_new;
                ...
                $qs_find_old_gen = $db
                    ...
                    ->exec(' SELECT
                                    id
                            FROM hgsptth_new AS a
                            WHERE tanggal_awal = :dari_tanggal AND a.id_htsptth_new = :id_htsptth_new
                            '
                            );
                    ...
                    ->exec('INSERT INTO htssctd
                        ...
                        WITH CopyJadwal AS (
                            SELECT
                                ...
                                d.kode
                            FROM htssctd AS a
                            LEFT JOIN hgsptth_new AS f ON f.tanggal_awal = :dari_tanggal
                            LEFT JOIN htsxxmh AS d ON d.id = a.id_htsxxmh
                            LEFT JOIN hgsptth_new AS e ON e.id = :id_hgsptth_new
                ...
                ->exec('INSERT INTO htssctd
                    ...
                    LEFT JOIN (
                            SELECT
                                ...
                                grup,
                            CASE
                                WHEN shift - 1 = 0 THEN (SELECT MAX(shift) FROM pola_shift_new)
                                ELSE shift - 1
                            END AS shift
                        FROM pola_shift_new
                    ) AS b ON b.id_htsptth_new = a.id_htsptth_new AND b.grup = a.grup
                    LEFT JOIN htststd_new AS c ON c.id_htsptth_new = a.id_htsptth_new AND c.shift = b.shift
                    LEFT JOIN htsxxmh AS d ON d.id = c.id_htsxxmh
                    LEFT JOIN (
                        SELECT
        ...
        $qu_hgsptth_new = $db
            ->query('update', 'hgsptth_new')
            ->set('generated_on',$timestamp)
            ->where('id',$id_hgsptth_new)
        ->exec();
