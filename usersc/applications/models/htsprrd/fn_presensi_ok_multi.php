    ...
    try {
        ...
        foreach ($id_htsprrd_arr as $key => $id_htsprrd) {
            $qs_htsprrd = $db
                ...
                ->get([
                    ' id_hemxxmh as id_hemxxmh_select',
                    ' htlxxrh_kode',
                    ' tanggal'
                ] )
                ->where('id', $id_htsprrd )
            ...
            foreach ($rs_htsprrd as $key => $report) {
                $htlxxrh_kode   = $report['htlxxrh_kode'];
                $id_hemxxmh_select   = $report['id_hemxxmh_select'];
            
                $tanggal_select = new Carbon($report['tanggal']); //gunakan carbon untuk ambil data tanggal
