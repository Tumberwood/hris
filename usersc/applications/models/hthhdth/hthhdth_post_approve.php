    ...
    try{
        ...
        if ($state == 1) {
            ...
            ->exec('UPDATE htssctd AS a
                    ...
                    WHERE 
                        tanggal = :tanggal AND jb.id_hetxxmh NOT IN (99, 48, 131) AND id_heyxxmd <> 4
                        AND a.is_active = 1
                        ;
            ');
            ...
            $qr_tanggal = $db
                ...
                ->exec('INSERT INTO htssctd
                    ...
                    WHERE 
                        tanggal = :tanggal
                    AND keterangan = CONCAT("Public Holiday - ", :nama) AND jb.id_hetxxmh NOT IN (99, 48, 131) AND id_heyxxmd <> 4
                ');
            // END insert pengaju
                        ...
                        WHERE 
                            id_hemxxmh IN (
                                SELECT
                                    id_hemxxmh
                                FROM hemjbmh
                                WHERE id_hetxxmh NOT IN (99, 48, 131) AND id_heyxxmd <> 4
                            )
                            AND is_active = 1
                            AND tanggal = :tanggal
