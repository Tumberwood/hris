...
$qs_outstanding_pr = $db
	...
	->exec('SELECT
				...
				ROUND(if(c.c_id = 1, htsprrd.durasi_lembur_total_jam, htsprrd.durasi_lembur_total_jam ),1)  AS durasi_lembur_total_jam,
				ROUND(if(c.c_id = 1, htsprrd.lembur15, htsprrd.lembur15 ),1)  AS lembur15,
				ROUND(if(c.c_id = 1, htsprrd.lembur2, htsprrd.lembur2 ),1)  AS lembur2,
				ROUND(if(c.c_id = 1, htsprrd.lembur3, htsprrd.lembur3 ),1)  AS lembur3,
				ROUND(if(c.c_id = 1, htsprrd.lembur4, htsprrd.lembur4 ),1)  AS lembur4,
				ROUND(if(c.c_id = 1, htsprrd.pot_jam, htsprrd.pot_jam ),1)  AS pot_jam,
				ROUND(if(c.c_id = 1, htsprrd.pot_ti, htsprrd.pot_ti ),1)  AS pot_ti,
				ROUND(if(c.c_id = 1, htsprrd.pot_overtime, htsprrd.pot_overtime ),1)  AS pot_overtime,
				ROUND(if(c.c_id = 1, htsprrd.durasi_lembur_final, htsprrd.durasi_lembur_final ),1)  AS durasi_lembur_final,
