<?php
	...
	$editor = Editor::inst( $db, 'htsprrd' )
		...
		->fields(
			...
			Field::inst( 'htsprrd.lembur15' ),
			Field::inst( 'htsprrd.lembur2' ),
			Field::inst( 'htsprrd.lembur3' ),
			Field::inst( 'htsprrd.lembur4' ),
			Field::inst( 'htsprrd.lembur15_final' ),
			Field::inst( 'htsprrd.lembur2_final' ),
			Field::inst( 'htsprrd.lembur3_final' ),
			Field::inst( 'htsprrd.lembur4_final' ),
			Field::inst( 'htsprrd.rp_lembur15' ),
			Field::inst( 'htsprrd.rp_lembur2' ),
			Field::inst( 'htsprrd.rp_lembur3' ),
			Field::inst( 'htsprrd.rp_lembur4' ),
			Field::inst( 'htsprrd.nominal_lembur_jam' ),
		...
		->where( 'htsprrd.durasi_lembur_final', 0, '>' );
